...
// Utiliser la prop id si elle est fournie, sinon utiliser route.params.id
...
// Watcher pour newsId afin de recharger les détails quand l'id change
watch(newsId, async () => {
...
<template>
    ...
    <div v-else>
        ...
        <!-- Section d'en-tête -->
        <div class="tp-team-details-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
