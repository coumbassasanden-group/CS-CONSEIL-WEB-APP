            ...
            <div class="row">
                <div class="col-lg-9 col-md-6">
                    <div class="tp-contact-title-wrap mb-30">
                        <span class="fw-600 fs-20 cs-text-dark mb-5 d-inline-block">{{ t('contact.contact_with_us') }}</span>
                        <h3 class="mb-20 fs-xl-40 fs-sm-36 wow cs-text-gold img-custom-anim-left cs-ff-montserrat"
                            data-wow-duration="1.5s" data-wow-delay="0.2s">{{ t('contact.how_to_find') }}</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tp-contact-main-info mb-30">
                        <div class="d-flex align-items-center mb-20">
                            ...
                            <div>
                                <span class="cs-text-gold fw-600 fs-12 text-uppercase d-block lh-1 mb-5 cs-ff-poppins">
                                    {{ t('contact.call_directly') }}</span>
                                <a href="tel:+(225)0710102943"
                                    class="fw-600 fs-16 ls-m-2 cs-text-brown underline-black">(+225) 07 10 10 29 43</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-20">
                            <span class="tp-contact-main-icon mr-15">
                            ...
                            <div>
                                <span class="cs-text-gold fw-600 fs-12 text-uppercase d-block lh-1 mb-5 cs-ff-poppins">
                                    {{ t('contact.need_support') }}</span>
                                <a href="mailto:contact@coumbassa-sanden.com"
                                    class="fw-600 fs-16 ls-m-2 cs-text-dark underline-black cs-ff-poppins">contact@coumbassa-sanden.com</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-20">
                            <span class="tp-contact-main-icon mr-15">
                                ...
                                <i class="fa-brands fa-linkedin fs-3 text-primary"></i>
                            </span>
                            <div>
                                <a href="https://www.linkedin.com/company/cabinet-coumbassa-sanden/" class="fw-600 fs-16 ls-m-2 cs-text-dark underline-black cs-ff-poppins">cabinet-coumbassa-sanden</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-20">
                            <span class="tp-contact-main-icon mr-15">
                                ...
                                <i class="fa-brands fa-youtube fs-3 text-danger"></i>
                            </span>
                            <div>
                                <a href="https://www.linkedin.com/company/cabinet-coumbassa-sanden/" class="fw-600 fs-16 ls-m-2 cs-text-dark underline-black cs-ff-poppins">cabinet-coumbassa-sanden</a>
                            </div>
